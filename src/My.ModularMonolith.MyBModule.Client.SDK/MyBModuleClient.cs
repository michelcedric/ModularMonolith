...
namespace My.ModularMonolith.MyBModule.Client.SDK
{
    ...
    public partial interface IWorkPreparationClient
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast2>> GetApiWeatherForecast2Async();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast2>> GetApiWeatherForecast2Async(System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast2>> GetApiWeatherForecast2Async()
        {
            return GetApiWeatherForecast2Async(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast2>> GetApiWeatherForecast2Async(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "MyBModule/api/WeatherForecast2"
                    urlBuilder_.Append("MyBModule/api/WeatherForecast2");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<WeatherForecast2>>(response_, headers_, cancellationToken).ConfigureAwait(false);
